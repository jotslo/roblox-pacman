...
local function ChangeMode()
	...
	elseif TimeInMode == 500 and Mode == "Chase" then
		Mode = "Scatter"
		TimeInMode = 0
		OverallTarget = Vector2.new(9, 0)
...
function Blinky:Run()
	...
	coroutine.wrap(function()
		MoveScript:Update(Ghost, Direction, DesiredDir, Vector2.new(3, 3))
		while Running do
			wait(0.04)
			local NewDir
...
function Blinky:Reset(CanContinue)
	Running = false
	coroutine.wrap(function()
		wait(1)
		Ghost.Position = UDim2.new(0.465, 0, 0.332, 0)
		Direction = "Left"
		MostRecentDir = "Left"
		DesiredDir = "Down"
