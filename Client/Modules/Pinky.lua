...
function Pinky:Reset(CanContinue)
	Running = false
	coroutine.wrap(function()
		wait(1)
		Ghost.Position = UDim2.new(0.463, 0, 0.427, 0)
		Direction = "Left"
		MostRecentDir = "Left"
		DesiredDir = "Down"
